...
from quizroom.models import Course, Category, Grade

from quizroom.forms import NewCourseForm
...
def Categories(request):
	...
	return render(request, 'quizroom/categories.html', context)
...
def CategoryCourses(request, category_slug):
	...
	return render(request, 'quizroom/categorycourses.html', context)
...
def NewCourse(request):
	...
	return render(request, 'quizroom/newcourse.html', context)
...
def CourseDetail(request, course_id):
	...
	return render(request, 'quizroom/course.html', context)
...
def EditCourse(request, course_id):
	...
	return render(request, 'quizroom/editcourse.html', context)
...
def MyCourses(request):
	...
	return render(request, 'quizroom/mycourses.html', context)
...
def Submissions(request, course_id):
	...
	return render(request, 'quizroom/submissions.html', context)
...
def StudentSubmissions(request, course_id):
	...
	return render(request,'quizroom/studentgrades.html', context)
...
def GradeSubmission(request, course_id, grade_id):
	...
	return render(request, 'quizroom/gradesubmission.html', context)
